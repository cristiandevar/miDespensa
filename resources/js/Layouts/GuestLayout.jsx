...
export default function Guest({className, textMain, textTitle, textSubtitle, children }) {
    return (
        <div className= {`min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100` + className}>
            {/* <div>
                <Link href="/">
                    ...
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                <span className="mb-1.5 block font-medium">{textSubtitle} </span>
