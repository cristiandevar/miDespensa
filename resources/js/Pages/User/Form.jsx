                    ...
                    <div className="p-8 w-full">
                        ...
                        <form onSubmit={submit}>
                            ...
                            <div className="mb-5">
                                ...
                                <PrimaryButton className="justify-center cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90" disabled={processing}>
                                    {labelButton}
                                </PrimaryButton>
                            </div>
                        </form>
