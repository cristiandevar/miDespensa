...
export default function UserForm({routeForm, titleForm, labelButton, msgSuccess, msgError, children, dataForm, id}) {
    ...
    const { data, setData, setError, post, put, patch, processing, errors, reset } = useForm({
        ...
        email: id?dataForm.email:'',
        password: id?dataForm.password:'',
        password_confirmation: id?dataForm.password_confirmation:'',
        active : id?dataForm.active:false,
    });
    ...
    const submit = (e) => {
        ...
        :
            patch(route(routeForm, dataForm), {
                onSuccess:(page) => {
                    setData({
                        id: page.props.user_updated.id,
                        name : page.props.user_updated.name,
                        email : page.props.user_updated.email,
    ...
    <>
        ...
        <Form
            ...
            submit = {submit}
            titleForm = {titleForm}
            labelPrimaryButton = {labelButton}
            labelBackButton = 'Atras'
            showMsgSuccess = {showMsgSuccess}
        ...
        >
            ...
            { (!dataForm)? //Si se actualiza un usuario, no permitir que se ingrese password
                <>
                <div className="mb-4">
                    <label htmlFor="password" className="block text-gray-700 text-sm font-bold mb-2 text-xs">Password</label>
                ...
                <div className="mb-6">
                    <label htmlFor="password_confirmation" className="block text-gray-700 text-sm font-bold mb-2 text-xs">Repite Password</label>
                    <div className="relative">
                        <input
